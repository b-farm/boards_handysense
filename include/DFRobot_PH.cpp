...
void DFRobot_PH::set_PHcal(float PH4voltage, float PH7voltage)
{
    this->_acidVoltage    = PH4voltage;    //buffer solution 4.0 at 25C
    this->_neutralVoltage = PH7voltage;     //buffer solution 7.0 at 25C
}
