module.exports = function (Blockly) {
      ...
      this.appendDummyInput()
        .appendField(
          new Blockly.FieldImage(
            "/static/icons/icons8_wifi_26px.png",
            20,
            20,
            "*"
          )
  ...
  Blockly.Blocks["time_get_day"] = {
    init: function () {
      this.appendDummyInput().appendField("get day of month");
      this.setInputsInline(true);
      this.setOutput(true, "Number");
      this.setColour(0);
  ...
  Blockly.Blocks["time_get_day_of_week"] = {
    init: function () {
      this.appendDummyInput().appendField("get day of week");
      this.setInputsInline(true);
      this.setOutput(true, "Number");
      this.setColour(0);
      this.setTooltip(
        "get day of week (Sunday = 0 , Monday = 1 , ... , Saturday = 6) (use sync time block first)"
      );
      this.setHelpUrl("");
    },
  };
  ...
  Blockly.Blocks["time_get_minute"] = {
    init: function () {
      ...
      this.setColour(0);
      this.setTooltip(
        "get minute of now hour 0-59 (use sync time block first)"
      );
      this.setHelpUrl("");
    },
  };
  ...
  Blockly.Blocks["time_millis"] = {
    init: function () {
      this.appendDummyInput().appendField("timestamp millisecond");
      this.setInputsInline(true);
  ...
  Blockly.Blocks["time_micros"] = {
    init: function () {
      this.appendDummyInput().appendField("timestamp microsecond");
      this.setInputsInline(true);
      this.setOutput(true, ["Number", "uint32_t"]);
      this.setColour(0);
