...
module.exports = function (Blockly) {
  ...
  Blockly.Blocks["bt_start"] = {
    init: function () {
      this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldTextInput("B-FARM"), "name");
      this.setInputsInline(true);
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
      this.setColour("#7086cb");
  ...
  Blockly.Blocks["bt_on_receive"] = {
    init: function () {
      this.appendDummyInput().appendField("on Bluetooth received data");
      this.appendStatementInput("receiver_code").setCheck(null);
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
      this.setColour("#7086cb");
      this.setTooltip("");
  ...
  Blockly.Blocks["bt_read_data"] = {
    init: function () {
      this.appendDummyInput().appendField("read Bluetooth received data");
      this.setInputsInline(true);
  ...
  Blockly.Blocks["bt_read_line"] = {
    init: function () {
      this.appendDummyInput().appendField("read line from Bluetooth data");
      this.setInputsInline(true);
      this.setOutput(true, "String");
      this.setColour("#7086cb");
