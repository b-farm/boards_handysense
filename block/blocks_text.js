...
module.exports = function (Blockly) {
    ...
    updateShape_: function () {
      ...
      if (this.itemCount_) {
        ...
        if (!this.getInput("TITLE")) {
          this.appendDummyInput("TITLE").appendField("Create input with");
        }
      } else {
      ...
      buttons.appendField(
        new Blockly.FieldImage("/static/icons/plus.png", 20, 20, "*", add, true)
      );
  ...
  Blockly.Blocks["text_trim"] = {
    ...
    init: function () {
      ...
      this.setColour(Blockly.Msg.TEXTS_HUE);
      this.appendValueInput("TEXT").setCheck("String").appendField("trim");
      this.setOutput(false);
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
