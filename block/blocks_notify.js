module.exports = function (Blockly) {
  ...
  Blockly.Blocks["line_set_token"] = {
    init: function () {
      this.appendDummyInput().appendField("LINE Set Token");
      this.appendValueInput("token").appendField("TOKEN: ");
      this.setInputsInline(true);
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
      this.setColour("#058107");
  ...
  Blockly.Blocks["line_notify"] = {
    init: function () {
      this.appendDummyInput().appendField("LINE Notify");
      this.appendValueInput("msg").appendField("Message: ");
      this.setInputsInline(true);
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
      this.setColour("#058107");
  ...
  Blockly.Blocks["line_sticker_msg"] = {
    init: function () {
      this.appendDummyInput().appendField("Line Message & Sticker");
      this.appendValueInput("msg").appendField("Message: ");
      this.appendDummyInput()
        .appendField("PackageId: ")
  ...
  Blockly.Blocks["line_notify_picture"] = {
    init: function () {
      this.appendDummyInput().appendField("LINE Picture");
      this.appendValueInput("url").appendField("URL: ");
      this.setInputsInline(true);
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
      this.setColour("#058107");
  ...
  Blockly.Blocks["line_notify_picture_msg"] = {
    init: function () {
      this.appendDummyInput().appendField("LINE Message & Picture");
      this.appendValueInput("msg").appendField("Message: ");
      this.appendValueInput("url").appendField("URL: ");
      this.setInputsInline(true);
      this.setPreviousStatement(true, null);
