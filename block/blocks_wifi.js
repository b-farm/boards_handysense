...
module.exports = function (Blockly) {
  ...
  Blockly.Blocks["wifi_connect"] = {
    init: function () {
      this.appendDummyInput()
        ...
        // .appendField(this.$global.setting.email)
      ...
      this.setColour("#583e72");
      this.setTooltip("connect WiFi");
      this.setHelpUrl("");
    },
  };
  
  Blockly.Blocks["wifi_connect_v2"] = {
    init: function () {
      this.appendDummyInput()
        .appendField("connect WiFi ssid")
        .appendField(new Blockly.FieldTextInput("test"), "ssid")
  ...
  Blockly.Blocks["wifi_ap"] = {
    init: function () {
      this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldTextInput("B-FARM"), "ssid")
        .appendField("password")
  ...
  Blockly.Blocks["wifi_server_on"] = {
    init: function () {
      ...
      this.appendStatementInput("event_do").setCheck(null);
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
      this.setColour("#583e72");
  ...
  Blockly.Blocks["wifi_get_ip_addr"] = {
    init: function () {
      this.appendDummyInput().appendField("get IP address");
      this.setInputsInline(true);
      this.setOutput(true, "String");
      this.setColour("#583e72");
  ...
  Blockly.Blocks["wifi_get_ap_ip_addr"] = {
    init: function () {
      this.appendDummyInput().appendField("get SoftAP IP address");
      this.setInputsInline(true);
      this.setOutput(true, "String");
      this.setColour("#583e72");
